...
## 🧾 Project Overview
The objective was to create an **interactive Power BI dashboard** for business stakeholders, offering clear and actionable insights from the SuperStore dataset.
